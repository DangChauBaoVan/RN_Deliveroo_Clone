...
const RestaurantScreen = () => {
  ...
  const renderBasket = () => {
    if (items.length > 0) return <BasketIcon />
    return
  }
  return (
    <>
      ...
      <ScrollView>
        <View className="relative">
          ...
          />
          <TouchableOpacity className="absolute top-14 left-5 bg-gray-100 p-2 rounded-full shadow-sm" onPress={navigation.goBack}>
        ...
        <View className="bg-white">
          <View className="px-4 pt-4">
            ...
            <View className="flex-row items-center space-x-2 my-1">
              <View className="flex-row items-center space-x-1">
                ...
                <Text className="text-xs text-gray-500"><Text className="text-green-700">{rating}</Text> • {genre}</Text>
              </View>
              <View className="flex-row items-center space-x-1">
          ...
          <TouchableOpacity className="flex-row items-center space-x-2 p-4 border-y border-gray-300">
            ...
            <Text className="pl-2 flex-1 text-md font-bold">Have a food allegy?</Text>
